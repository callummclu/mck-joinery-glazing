...
const Joinery: NextPage = ({ categories,contact}:any) => {
    ...
    const categoriesMapped = categories.filter((cat:any)=>cat.parent === "Joinery").map((e:any) => <CategoryDiv onClick={()=>router.push(`gallery/${e.parent}/${e.type}`)}>{e.type}</CategoryDiv>)
