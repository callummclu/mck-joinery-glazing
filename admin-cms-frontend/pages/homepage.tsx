...
export const Homepage: NextPage = ({ homePage,category }:any) => {
  ...
  <Nav>
    <Container>
                ...
                <MultiSelect onChange={(e:any)=>setShownCategory(e)} label="Shown Categories" defaultValue={homePage.shownCategories || [category[0].type,category[1].type]} maxSelectedValues={2} data={mappableCategories} />
